...
export const es: Dictionary = {
  ...
  testimonials: {
    ...
    videoCta: 'Ver testimonios',
    videoTitle: 'Familias NWL comparten su experiencia',
    items: [
      {
        quote:
  ...
  maternal: {
    ageBadge: '2-3 años · Early Learning',
  ...
  kinder: {
    ageBadge: '3–5 años · Kindergarten',
  ...
  elementaryPage: {
    ...
    activities: [
      { name: 'Deportes', description: 'Fútbol, básquetbol, taekwondo y el reto de obstáculos Gladiators Race.' },
      { name: 'Arte y Cultura', description: 'Dance team, teatro y artes visuales que impulsan la creatividad y la confianza.' },
      { name: 'Música', description: 'Clases de instrumentos y presentaciones en conjunto que nutren disciplina y expresión.' },
      { name: 'STEAM', description: 'Proyectos prácticos en ciencia, tecnología y resolución creativa de problemas.' },
    ],
  ...
  careers: {
    ...
    whyBenefits: [
      ...
      { title: 'Ambiente Colaborativo', description: 'Trabaja junto a educadores apasionados en una comunidad cercana, innovadora y de apoyo mutuo.' },
      { title: 'Innovación Educativa', description: 'Accede a metodologías de vanguardia, tecnología y recursos como Knotion, Apple y programas internacionales.' },
      { title: 'Impacto Comunitario', description: 'Forma el futuro de miles de estudiantes en nuestros 5 campus en Querétaro y San Miguel de Allende.' },
    ],
    jobsTitle: 'Vacantes',
    jobsTitleAccent: 'Disponibles',
    jobsSubtitle: 'Explora nuestras oportunidades actuales en todos los campus.',
    jobsFilterAll: 'Todos los Campus',
    jobsNoPositions: 'No hay vacantes que coincidan con tu filtro en este momento. Vuelve pronto o envía tu CV a continuación.',
    jobsApplyBtn: 'Aplicar Ahora',
    jobsRequirements: 'Requisitos',
    jobsDepartment: 'Departamento',
    processTitle: 'Proceso de',
    processTitleAccent: 'Aplicación',
    processSubtitle: 'Nuestro proceso de aplicación está diseñado para conocerte de manera integral. Estos son los pasos:',
    processSteps: [
      { title: 'Información Personal', description: 'Nombre, contacto y datos de ubicación.' },
      { title: 'Experiencia Profesional', description: 'Tu historial laboral y posiciones relevantes.' },
      { title: 'Formación Académica', description: 'Títulos, diplomas y formación educativa.' },
      { title: 'Cursos y Certificaciones', description: 'Desarrollo profesional y capacitación especializada.' },
      { title: 'Habilidades Tecnológicas', description: 'Herramientas y plataformas tecnológicas que dominas.' },
      { title: 'Idiomas', description: 'Nivel de dominio y certificaciones de idiomas.' },
      { title: 'Especialidades', description: 'Áreas de experiencia y niveles de especialización.' },
      { title: 'Habilidades y Carga de CV', description: 'Sube tu CV y destaca tus principales fortalezas.' },
    ],
    ...
    partnerBenefits: [
      { title: 'Visibilidad de Marca', description: 'Llega a miles de familias en nuestros 5 campus.' },
      { title: 'Impacto Educativo', description: 'Contribuye a programas innovadores que forman jóvenes mentes.' },
      { title: 'Acceso a la Comunidad', description: 'Conéctate con una comunidad comprometida de padres, educadores y estudiantes.' },
      { title: 'Alianza Estratégica', description: 'Co-crea programas, eventos e iniciativas que beneficien a ambas organizaciones.' },
    ],
  },
  admin: {
    ...
    dashboardTitle: 'Vacantes',
    newJobButton: 'Nueva Vacante',
    logoutButton: 'Cerrar Sesión',
    noJobs: 'No hay vacantes aún. Crea tu primera posición.',
    tableTitle: 'Título',
    tableCampus: 'Campus',
    tableStatus: 'Estado',
    tableCreated: 'Creado',
    ...
    deleteConfirm: '¿Estás seguro de que deseas eliminar esta vacante? Esta acción no se puede deshacer.',
    formCreateTitle: 'Crear Vacante',
    formEditTitle: 'Editar Vacante',
    formTitleEn: 'Título (Inglés)',
    formTitleEs: 'Título (Español)',
    formCampus: 'Campus',
    formDescriptionEn: 'Descripción (Inglés)',
    formDescriptionEs: 'Descripción (Español)',
    formRequirementsEn: 'Requisitos (Inglés)',
    formRequirementsEs: 'Requisitos (Español)',
    formDepartmentEn: 'Departamento (Inglés)',
    formDepartmentEs: 'Departamento (Español)',
    formActive: 'Activo',
    formSave: 'Guardar',
    formCancel: 'Cancelar',
  ...
  rectoria: {
    heroEyebrow: 'NWL Australian School · Rectoría',
    heroTitle: 'Las personas que hacen de cinco campus',
    heroTitleAccent: 'una sola escuela',
    heroSubtitle:
      'Rectoría es el equipo directivo central de NWL Australian School. Es responsable del modelo académico, la administración, las personas y la comunicación que comparten los cinco campus.',
    backHome: 'Inicio',
    execEyebrow: 'Dirección Ejecutiva',
    execAsideLabel: 'Oficina de Dirección Ejecutiva',
    areasEyebrow: 'Áreas de Rectoría',
    areasTitle: 'Cinco áreas,',
    areasTitleAccent: 'una sola escuela',
    areasSubtitle:
      'Cada área opera en los cinco campus.',
    teamLabel: 'Equipo',
    directorsEyebrow: 'Dirección General de Campus',
    ...
    ctaSubtitle: 'Consulta las vacantes o visita un campus.',
    ctaPrimary: 'Trabaja con nosotros',
    ctaSecondary: 'Visita un campus',
  },
  padres: {
    heroTitle: 'Portal de',
    heroTitleAccent: 'Padres',
    heroSubtitle: 'Accede al calendario escolar, menú de cafetería, comunicados y listas de útiles de tu campus.',
    selectCampus: 'Selecciona tu Campus',
    selectCampusSubtitle: 'Elige el campus de tu hijo para acceder al portal',
    passwordTitle: 'Acceso al Portal',
    passwordSubtitle: 'Ingresa la contraseña proporcionada por tu campus',
    passwordPlaceholder: 'Contraseña',
    passwordButton: 'Acceder',
    passwordError: 'Contraseña incorrecta. Verifica con tu campus.',
    welcomeMessage: 'Bienvenido al portal de padres',
    changeCampus: 'Cambiar campus',
    logoutButton: 'Cerrar sesión',
    tabCalendario: 'Calendario',
    tabCafeteria: 'Cafetería',
    tabComunicados: 'Comunicados',
