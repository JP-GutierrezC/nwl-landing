...
export const en: Dictionary = {
  ...
  beneficios: {
    eyebrow: 'NWL Community',
    title: 'Benefits &',
    titleAccent: 'Partnerships',
    subtitle:
      'Partners that recognize the NWL family with exclusive discounts and benefits in health, wellness and more.',
    statPartners: 'partners',
    statCategories: 'categories',
    catalogTitle: 'Benefits for',
    catalogTitleAccent: 'our community',
    catalogSubtitle:
      'Browse by category and enjoy every benefit by presenting your NWL credential.',
    filterAll: 'All',
    vigenciaLabel: 'Valid',
    ...
    howToSubtitle: 'Enjoying your NWL benefits is simple.',
    howToSteps: [
      {
        title: 'Identify as NWL community',
        description: 'You are a student, direct family member or staff of Colegio NWL.',
      },
      {
      ...
      },
      {
        ...
        description: 'The exclusive discount or benefit is applied right away.',
      },
    ],
    applyTitle: 'Want your business to become',
    applyTitleAccent: 'an NWL partner?',
    applySubtitle:
      'Add your brand to the benefits catalog and connect with the entire NWL community of families and staff.',
    applyBenefits: [
      'Exposure to thousands of NWL community families',
      'No enrollment cost to join the program',
      'Promotion across our official channels',
    ],
    applyFormId: 'naXZnvvAoMuM86L1OwqV',
    applyFormName: 'Formulario para Empresas web',
    applyFormTitle: 'Formulario para Empresas web',
    applyFormPlaceholder: 'Registration form',
    applyFormPlaceholderNote: 'You will soon be able to register your business here.',
  },
  levels: {
  ...
  testimonials: {
    ...
    videoCta: 'Watch their stories',
    videoTitle: 'NWL families share their experience',
    items: [
      {
        quote:
  ...
  rectoria: {
    ...
    heroTitle: 'The people who make five campuses',
    heroTitleAccent: 'one school',
    heroSubtitle:
      'Rectoría is the central leadership team of NWL Australian School. It is responsible for the academic model, administration, people and communications shared by the five campuses.',
    backHome: 'Home',
    execEyebrow: 'Executive Office · Dirección Ejecutiva',
    execAsideLabel: 'Executive Office',
    areasEyebrow: 'Áreas de Rectoría',
    areasTitle: 'Five areas,',
    areasTitleAccent: 'one school',
    areasSubtitle:
      'Each area operates across the five campuses.',
    teamLabel: 'Team',
    directorsEyebrow: 'Dirección General de Campus',
    directorsTitle: 'Five campuses,',
    directorsTitleAccent: 'five directors',
    directorsSubtitle:
      'Each campus has its own general director. Their message to families lives on the campus page.',
    directorsLink: 'Read their message',
    ctaTitle: 'Want to build this',
    ctaTitleAccent: 'with us?',
    ctaSubtitle: 'See open positions or visit a campus.',
    ctaPrimary: 'Work with us',
    ctaSecondary: 'Visit a campus',
  },
  padres: {
    heroTitle: 'Parents',
    heroTitleAccent: 'Portal',
    heroSubtitle: 'Access your campus calendar, cafeteria menu, announcements, and school supply lists.',
    selectCampus: 'Select Your Campus',
    selectCampusSubtitle: "Choose your child's campus to access the portal",
    passwordTitle: 'Portal Access',
    passwordSubtitle: 'Enter the password provided by your campus',
    passwordPlaceholder: 'Password',
    passwordButton: 'Access Portal',
    passwordError: 'Incorrect password. Please check with your campus.',
    welcomeMessage: 'Welcome to the parents portal',
    changeCampus: 'Change campus',
    logoutButton: 'Log out',
    tabCalendario: 'Calendar',
    tabCafeteria: 'Cafeteria',
    tabComunicados: 'Announcements',
